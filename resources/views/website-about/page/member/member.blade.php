  ...
  <div class="col-lg-12">
   <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
       ...
       <a href="{{ route('website.about.member.create') }}" class="btn btn-success"> <i class="fa fa-plus"></i> Add member</a>
    </div>
    ...
    <form action="{{ route('website.about.member.header.store') }}" method="post" enctype="multipart/form-data"
...
<script>
    ...
    var table = $('#datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('website.about.member') }}",
        columns: [
