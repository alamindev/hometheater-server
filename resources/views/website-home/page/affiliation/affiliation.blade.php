  ...
  <div class="col-lg-12">
   <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
       ...
       <a href="{{ route('website.home.affiliation.create') }}" class="btn btn-success"> <i class="fa fa-plus"></i> Add new</a>
    </div>
    ...
    <form action="{{ route('website.home.affiliation.header.store') }}" method="post"
...
<script>
    ...
    var table = $('#datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('website.home.affiliation') }}",
        columns: [
