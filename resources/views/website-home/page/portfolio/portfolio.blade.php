  ...
  <div class="col-lg-12">
   <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
       ...
       <a href="{{ route('website.home.portfolio.create') }}" class="btn btn-success"> <i class="fa fa-plus"></i> Add portfolio</a>
    </div>
    ...
    <form action="{{ route('website.home.portfolio.header.store') }}" method="post" enctype="multipart/form-data"
...
<script>
    ...
    var table = $('#datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('website.home.portfolio') }}",
        columns: [
