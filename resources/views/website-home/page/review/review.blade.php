  ...
  <div class="col-lg-12">
   <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
       ...
       <a href="{{ route('website.home.review.create') }}" class="btn btn-success"> <i class="fa fa-plus"></i> Add review</a>
    </div>
    ...
    <form action="{{ route('website.home.review.header.store') }}" method="post" enctype="multipart/form-data"
...
<script>
    ...
    var table = $('#datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('website.home.review') }}",
        columns: [
