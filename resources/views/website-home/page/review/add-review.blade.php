...
@section('title')
   Add new dummy review
@endsection

@section('website-home')
<div class="content">
    <form action="{{ route('website.home.review.store') }}" method="post"  enctype="multipart/form-data" class="form-horizontal">
        @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                   <div class="card-header d-flex justify-content-between align-items-center">
                        <h3> Add New Dummy review</h3>
                    ...
                    <div class="card-body card-block">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="location" name="location" value="{{ old('location')}}" class="form-control" placeholder="Enter Location">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step=".5" min=".5" max="5" id="rating" name="rating" value="{{ old('rating')}}" class="form-control"  >
                        </div>
                        <div class="form-group">
                            <label for="text" class="form-control-label">Rating text<span class="text-danger">*</span></label>
                            <textarea name="text" rows="5" id="text" class="form-control">{{ old('text')}}</textarea>
                        </div>
                        <br>
