<header  >
    <ul class="website-new-header">
        ...
        <li class="<?php echo e(Route::is('website.home.productheader')   ? 'active' : ''); ?>"><a href="<?php echo e(route('website.home.productheader')); ?>">Product header</a></li>
...
<?php /**PATH F:\hometheater-proz\server\resources\views/website-home/partials/header.blade.php ENDPATH**/ ?>