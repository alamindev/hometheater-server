...
<form action="<?php echo e(route('website.home.topheader.store')); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="btn_text" name="btn_text" value="<?php echo e(!empty($edit) ? $edit->btn_text : ''); ?>" class="form-control" placeholder="Enter button text" >
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="btn_link" class=" form-control-label">Button link <span class="text-danger">*</span></label>
                                <input type="text" id="btn_link" name="btn_link" value="<?php echo e(!empty($edit) ? $edit->btn_link : ''); ?>" class="form-control" placeholder="Enter button link">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="second_btn_text" name="second_btn_text" value="<?php echo e(!empty($edit) ? $edit->second_btn_text : ''); ?>" class="form-control" placeholder="Enter button text" >
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="second_btn_link" class=" form-control-label">Second button link <span class="text-danger">*</span></label>
                                <input type="text" id="second_btn_link" name="second_btn_link" value="<?php echo e(!empty($edit) ? $edit->second_btn_link : ''); ?>" class="form-control" placeholder="Enter button link">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
...
<?php echo $__env->make('website-home.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/hometheaterproz.com/admin.hometheaterproz.com/resources/views/website-home/page/top-header/top-header.blade.php ENDPATH**/ ?>