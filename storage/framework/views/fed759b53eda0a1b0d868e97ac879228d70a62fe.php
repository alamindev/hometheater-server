  ...
  <div class="col-lg-12">
   <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
       ...
       <a href="<?php echo e(route('website.home.chooseus.create')); ?>" class="btn btn-success"> <i class="fa fa-plus"></i> Add Choose us</a>
    </div>
    ...
    <form action="<?php echo e(route('website.home.chooseus.header.store')); ?>" method="post" enctype="multipart/form-data"
...
<script>
    ...
    var table = $('#datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('website.home.chooseus')); ?>",
        columns: [
...
<?php echo $__env->make('website-home.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/hometheaterproz.com/admin.hometheaterproz.com/resources/views/website-home/page/choose-us/choose-us.blade.php ENDPATH**/ ?>