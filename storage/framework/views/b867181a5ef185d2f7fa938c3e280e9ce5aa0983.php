        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4>View Service</h4>
                    <a href="<?php echo e(url()->previous()); ?>" class="btn btn-success"> <i class="fa  fa-arrow-left "></i>
                        Back</a>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\hometheater-proz\server\resources\views/pages/order/view-service.blade.php ENDPATH**/ ?>