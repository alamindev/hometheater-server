...
<form action="<?php echo e(route('website.info.store','service')); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
...
<?php echo $__env->make('website-meta-info.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\hometheater-proz\server\resources\views/website-meta-info/page/service.blade.php ENDPATH**/ ?>