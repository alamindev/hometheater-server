    ...
    <div class="card-header">
      Generate Promo code
        ...
        <div class="card-body card-block">
            <form action="<?php echo e(route('promo.store')); ?>" method="post" class="form-horizontal" data-parsley-validate>
                <?php echo csrf_field(); ?>
                <div class="form-group">
                    ...
                    <?php if($errors->has('percent')): ?>
                        <div class="text-danger"><?php echo e($errors->first('percent')); ?></div>
                    <?php endif; ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?php if($errors->has('end_date')): ?>
                        <div class="text-danger"><?php echo e($errors->first('end_date')); ?></div>
                    <?php endif; ?>
                </div>
                <div class="form-group">
  ...
  <div class="col-lg-8">
   ...
   <div class="modal fade" id="smallmodal" tabindex="-1" role="dialog"   aria-labelledby="smallmodalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md" role="document">
                    <form action="<?php echo e(route('promo.update')); ?>" method="post"  class="form-horizontal">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/hometheaterproz.com/admin.hometheaterproz.com/resources/views/pages/promo/promo.blade.php ENDPATH**/ ?>