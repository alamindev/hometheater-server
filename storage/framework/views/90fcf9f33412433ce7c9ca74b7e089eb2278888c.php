                       ...
                       <div class="form-group" id="fonticon">
                        ...
                        <div class="form-group">
                            ...
                            <select data-placeholder="Suggestion" multiple name="suggestion[]" id="suggestion"
                                ...
                                $edit->id)->where('type', 0)->orderBy('created_at','desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\hometheater-proz\server\resources\views/pages/service/edit-service.blade.php ENDPATH**/ ?>