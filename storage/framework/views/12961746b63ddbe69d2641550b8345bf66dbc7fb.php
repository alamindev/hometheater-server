...
<form action="<?php echo e(route('website.home.serviceheader.store')); ?>" method="post" enctype="multipart/form-data"
                ...
                <div class="card-body card-block">
                    <div class="form-group">
                        ...
                        <input type="text" id="home_title" name="home_title" class="form-control"
                            value="<?php echo e(!empty($edit) ? $edit->home_title : ''); ?>" placeholder="Enter title">
                        <?php if(!empty($edit)): ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="home_details" id="home_details"
                            class="form-control">  <?php echo e(!empty($edit) ? $edit->home_details : ''); ?></textarea>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body card-block">
                    <div class="form-group">
                        ...
                        <input type="text" id="service_title" name="service_title" class="form-control"
                            value="<?php echo e(!empty($edit) ? $edit->service_title : ''); ?>" placeholder="Enter title">
                        <?php if(!empty($edit)): ?>
                        <input type="hidden" id="id" name="id" class="form-control" value="<?php echo e($edit->id); ?>">
                        <?php endif; ?>
                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="service_btn_text" name="service_btn_text"
                                    value="<?php echo e(!empty($edit) ? $edit->service_btn_text : ''); ?>" class="form-control"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="service_btn_link" name="service_btn_link"
                                    value="<?php echo e(!empty($edit) ? $edit->service_btn_link : ''); ?>" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <textarea cols="5" rows="5" name="service_details" id="service_details"
                            class="form-control">  <?php echo e(!empty($edit) ? $edit->service_details : ''); ?></textarea>
                    </div>
                    <div class="form-group">
        ...
        <div class="card-body card-block">
            <div class="form-group">
                ...
                <input type="text" id="booking_title" name="booking_title" class="form-control"
                    value="<?php echo e(!empty($edit) ? $edit->booking_title : ''); ?>" placeholder="Enter title">
            </div>
            <div class="form-group">
                ...
                <textarea name="booking_details" id="booking_details"
                    class="form-control">  <?php echo e(!empty($edit) ? $edit->booking_details : ''); ?></textarea>
            </div>
        </div>
    </div>
    <div class="card">
...
<?php echo $__env->make('website-home.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/hometheaterproz.com/admin.hometheaterproz.com/resources/views/website-home/page/service-header/service-header.blade.php ENDPATH**/ ?>