        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="<?php echo e(Route::is('order') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('order')); ?>"><i class="menu-icon fa fa-bookmark"></i> Order </a>
                </li>
                ...
                <li class="<?php echo e((Route::is('contacts') || Route::is('page.view')) ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('contacts')); ?>"><i class="menu-icon fa fa-address-book "></i> Contacts </a>
                </li>
...
<?php /**PATH /var/www/vhosts/hometheaterproz.com/admin.hometheaterproz.com/resources/views/partials/sidebar.blade.php ENDPATH**/ ?>